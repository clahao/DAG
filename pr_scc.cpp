...
//    start_node_list[scc[map[source_node]]].insert(map[source_node]);
    ...
    for(int i = 0; i < scc_num; i ++){
        ...
        if(scc_node_num[i] > 1){
            ...
            process_timer.Start();
//            pr_sync(cal_times,node_index,csr,csc,start_node_list[i],node_degree_map,node_degree_inv_map,global_delta,global_value,ouDegree,node_start_index,scc_node_num[i],num);
//            pr_async(cal_times,node_index,csr,csc,start_node_list[i],node_degree_map,node_degree_inv_map,global_delta,global_value,ouDegree,node_start_index,scc_node_num[i],num);
            pr_DAG(cal_times,node_index,csr,csc,start_node_list[i],node_degree_map,node_degree_inv_map,global_delta,global_value,ouDegree,node_start_index,scc_node_num[i],num);
