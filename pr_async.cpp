...
void pr_async(long long int &cal_times, const CSR& csr, set<int> start, vector<double> &global_delta, vector<double> &global_value, vector<int> outDegree, int start_id, int num_node ,int num){
    int n = num_node;
...
int main(int argc, char ** argv){
    ...
    Timer timer;
    timer.Start();
    pr_async(cal_times,csr,start,global_delta,global_value,outDegree,0,graph.num_nodes,num);
