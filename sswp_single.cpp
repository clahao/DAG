...
void sswp_async(long long int &cal_times, const CSR& csr, set<int> start, vector<int> &global_dist, int start_id, int num_node ,int num=1){
    int n = num_node;
...
int main(int argc, char ** argv){
    ...
    Timer timer;
    timer.Start();
    sswp_async(cal_times,csr,start,global_dist,0,graph.num_nodes);
